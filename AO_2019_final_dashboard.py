...
- Can see a strong concentration on the deuce court across the baseline and towards the middle of the court, aligning with Nadal's serve analysis showing a high percentage of first serves directed at the body/T.
                        \n- This concentration spreads slowly across to the advantage court, but is more even across the T and wide serves. The key difference on this side is the concentration on the backhand - it is shifted up into the court. 
                        \n- As hypothesised in earlier analyses, Djokovic was taking his backhand returns on the advantage side higher up the court. This prevented Nadal from creating angles to open space on the deuce court and also takes time away from Nadal to recover from his service action.
                        \n- Since Nadal is left handed, naturally Djokovic didn't have to return forehands from very wide on the deuce court, but had to deal with backhands wide of the tramlines on the advantage court. We would expect to see a similar but opposite pattern on the Nadal return heatmap.
                        \n- In retrospect, Nadal would have hoped to create more trouble for Djokovic returning on the deuce court; the highest concentration is within easy reach, meaning Nadal will not have generated many 'free' points from his serve on this side ('free' meaning aces, forced errors, or creation of short returns for easy winners on the 2nd shot).
                        \n- The vertical spread of the heatmap is much narrower on Djokovic's returns than Nadal's. This shows Djokovic was attempting to be more aggressive on his returns by taking them further up the court. 
                        \n- When compared to Nadal's heatmap, he was returning from much deeper behind the baseline at times, as the vertical spread of the heatmap was larger.
                        \n- Finally, the heatmap spills high into the court with a particular concentration into the right tramline. Nadal was attempting to utilise his wide serve on the advantage court; to counter this Djokovic took an aggressive returning approach, meeting these serves early and high into the court to mitigate the effect of being pulled off the court whilst giving Nadal less time to set up for his second shot.
                        """)
...
1. The high concentration of returns above the left tramline (Nadal backhand)
...
3. The other medium concentration of returns centrally, but just on the baseline
                        \n- Let's look at the first area. It's clear the majority of returns were being hit from here, as a result of Djokovic's wide serve on the deuce court. The high concentration indicates high frequency, which explains how Nadal managed to consistently return from not far behind the baseline on this side. Djokovic clearly believed the effectiveness of this serve outweighed how easy it became to anticipate.
                        \n- The second area complements this; Nadal was expecting the wide serve on the deuce court, so when Djokovic did decide to hit a T serve Nadal took longer to respond, hence taking his forehand returns on the deuce court from a much deeper position. To ensure Nadal didn't get comfortable anticipating the backhand return, the serve down the T clearly worked to good effect.
                        \n- Finally, the third area. This mirrors the first area partially, as Nadal was receiving this serve to his backhand which Djokovic was targetting on both sides of the court. Nadal again was able to predict the serve here more confidently/frequently hence could take the returns earlier. 
                        \n- As we saw on the Djokovic 1st serve analysis, he rarely served out wide to the Nadal forehand and looking at where the heatmap ends horizontally on the ad court, it's clear he wasn't hitting many second serves here either.
                        """)
