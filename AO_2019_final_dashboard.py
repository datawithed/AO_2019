...
3. The other medium concentration of returns centrally, but just on the baseline
                        ...
                        \n- The second area complements this, as Nadal was often expecting the wide serve on the deuce court, when Djokovic did decide to hit a T serve Nadal needed more time to respond, hence taking his forehand returns on the deuce court from a much deeper position. To ensure Nadal didn't get comfortable anticipating the backhand return, the serve down the T clearly worked to good effect.
