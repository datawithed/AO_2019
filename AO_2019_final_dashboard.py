...
\n- The drop shot is typically played when Nadal leaves a short ball on Djokovic's backhand - where he hits a short backhand slice down the line (as seen by the short balls in the service box)
                    \n- This exhibit provides evidence that Djokovic hit his backhand higher up the court, using a flatter grip to drill the backhand deep to push Nadal back, whilst using the topspin forehand to create angles off the court. This is shown as the spread of forehands (red) is more vertical than the spread of backhands (blue).
                    \n- In addition to this, Djokovic made sure not to open up the court on Nadal's forehand side which would have assisted him in creating more angles with his forehand. From the exhibit, Nadal's forehands are spread more vertically than wide - again worth noting the forehands have a centralised bias due to inside-out/in shots.
        ...
        f2.markdown("""
                    This exhibit shows Nadal's average backhands were being hit from a wider position on the court than his forehand. The width analyses for both players have shown that they have applied the typical left-hander vs right-hander strategy; attacking the opposition backhand with the forehand cross-court in a bid to open up the court with angles and draw a short ball to attack. 
                    \n Djokovic executed a well planned trade-off on his bcross-court backhand; this was to hit deeper and more centrally rather than trying to create an angle and pull him off the court. This lowered the margin for error that had significantly increased by taking his backhand on the rise inside the court, whilst simultaneously reducing the angles that Nadal could create on his forehand side. This can easily be seen in the exhibit as Nadal only hit one forehand wide of the outer tramline. 
                    \n Comparing the width analyses, we can see that Nadal's average backhand is being played from a wider average position than Djokovic's on the other side, showing Djokovic managed to create angles to push Nadal off-court with his forehand, whilst minimising the angles Nadal could create to push him off-court on his backhand side. In addition to this, Djokovic managed to generate great angles on his cross-court forehand, working Nadal wide of the tramlines frequently on his backhand as seen in the exhibit.
